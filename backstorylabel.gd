...
var msg = ["Welcome, everyone.",
	...
	"You happened to be one of them, and so was your sister.",
	"However...",
	"Your friends died.",
	"Your family died.",
	"Your neighbors died.",
	...
	"So now, when you find dropped leaflets for a place called “The Circus and Attractions”,",
	"claiming that a ship will be arriving just to pick up possible survivors...",
